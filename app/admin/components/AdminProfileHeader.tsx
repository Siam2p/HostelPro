...
export default function AdminProfileHeader({
    ...
    return (
        <div className="relative mb-8">
            <div className="h-32 md:h-48 bg-linear-to-r from-slate-700 to-slate-900 rounded-3xl shadow-lg -mb-16 md:-mb-20"></div>
                ...
                <div className="pb-2 w-full md:w-auto">
                    {!isEditing ? (
                        <Button
                            ...
                            className="rounded-2xl px-10 w-full md:w-auto h-14 font-black shadow-xl shadow-slate-200 bg-linear-to-r from-slate-700 to-slate-900 hover:scale-105 transition-all text-xs uppercase tracking-widest text-white"
                        >
                            তথ্য আপডেট করুন
                        </Button>
                    ) : (
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <Button onClick={onSaveRequest} disabled={isSaving} className="rounded-xl px-8 flex-1 bg-slate-800 text-white hover:bg-slate-700">
