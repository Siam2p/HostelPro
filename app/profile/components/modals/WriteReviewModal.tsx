    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <Card className="w-full max-w-lg p-0 rounded-4xl shadow-3xl animate-in zoom-in-95 duration-300 overflow-hidden border-none text-left">
                <div className="p-8 bg-linear-to-br from-primary-dip to-primary-dipto text-white">
                ...
                <div className="p-8 bg-gray-50 flex flex-col sm:flex-row gap-4">
                    ...
                    <Button
                        ...
                        className="w-full sm:grow-2 sm:basis-2/3 rounded-2xl h-14 font-black shadow-emerald bg-linear-to-r from-primary-dip to-primary-dipto transition-all uppercase tracking-widest text-xs"
                    >
                        রিভিউ জমা দিন
                    </Button>
                </div>
